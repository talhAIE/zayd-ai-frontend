...
const ChapterTopics: React.FC = () => {
  ...
  const isCurriculumMode = location.pathname.includes("curriculum-mode");
    ...
    return (
      ...
      >
        ...
        <div className="flex-grow px-5 py-4">
          ...
          {!isCurriculumMode && topic.cefrLevel && (
        ...
        {!isCurriculumMode && (
          <div className="flex items-center mb-6">
            <Button
              ...
              size="icon"
              onClick={() =>
                navigate("/student/learning-modes/curriculum-mode")
              }
              className="mr-2"
            >
