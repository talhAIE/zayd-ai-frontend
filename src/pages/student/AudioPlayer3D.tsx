...
interface AudioPlayer3DListeningProps {
  audioSrc: string;
  isPlaying: boolean;
  progress: number;
  duration: number;
...
const AudioPlayer3DListening: React.FC<AudioPlayer3DListeningProps> = ({
  isPlaying,
  progress,
  duration,
  onTogglePlay,
  ...
  const bars = React.useMemo(() => {
    const heights = [
      4, 8, 12, 16, 20, 16, 12, 8, 4, 8, 12, 16, 20, 24, 20, 16, 12, 8, 12,
      16, 20, 16, 12, 8, 4,
    ];
  ...
  return (
    <div className="flex items-center gap-2 w-full p-2 rounded-full bg-gray-100 border">
      <Button
        size="icon"
...
export default AudioPlayer3DListening;
