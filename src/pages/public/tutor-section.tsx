  ...
  english: {
    ...
    features: [
      ...
      },
      {
        ...
        arabicTitle: "التركيز",
        description:
          "Academic mastery of the Saudi Curriculum (Mega Goal / Super goal).",
        arabicDescription:
          "إتقان أكاديمي للمناهج السعودية (هدف ضخم / هدف عظيم).",
      },
      {
        emoji: "💪",
        title: "The Workout",
        arabicTitle: "التدريب",
        description:
          "High-frequency practice that turns school lessons into real-world confidence.",
        arabicDescription:
          "تمارين عالية التكرار تحول دروس المدرسة إلى ثقة في العالم الحقيقي.",
      },
    ],
  },
  chinese: {
    ...
    features: [
      {
        ...
        description:
          "Experience Chinese as it's spoken in real social contexts.",
        arabicDescription:
          "اختبر اللغة الصينية كما يتم التحدث بها في السياقات الاجتماعية الحقيقية.",
      },
      {
        emoji: "🥢",
        ...
        description:
          "Learn through structured lessons and improve with real-time feedback.",
        arabicDescription:
          "تعلم من خلال الدروس المنظمة وحسّن مستواك من خلال التقييم الفوري.",
      },
      {
        emoji: "🏯",
        ...
        description:
          "Practice every day to strengthen your skills and move toward fluency.",
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          >
            {isAr ? "مدربوك اللغويون الذكيون" : "Your AI Language Coaches"}
          </motion.h2>
          ...
          >
            {isAr
              ? "مدربان متخصصان، كل منهما مصمم لإتقان مجاله. اختر مدربك وابدأ التدريب."
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center gap-6 sm:gap-8 w-full">
            ...
            <div className="inline-flex items-center gap-3 px-5 sm:px-6 py-1.5 sm:py-2 rounded-full border border-gray-50 bg-white shadow-[0_4px_15px_rgba(0,0,0,0.02)]">
              <img
                src={activeTutor === "english" ? flagUK : flagChina}
                alt="Flag"
                className="w-4 h-4 sm:w-5 sm:h-5"
              />
