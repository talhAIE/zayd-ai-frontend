    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 relative">
        <div className="flex flex-col items-center text-center">
          ...
          >
            {isAr ? "جاهز للتحول" : "Ready to Transform"}
          </motion.div>
          ...
          >
            {isAr ? "هل أنت مستعد لتمرينك الأول؟" : "Ready for your first rep?"}
          </motion.h2>
          ...
          >
            {isAr
              ? "انضم إلى آلاف الطلاب الذين يبنون الطلاقة والدقة والثقة من خلال تدريب اللغة المدعوم بالذكاء الاصطناعي."
          ...
          >
            <button className="w-full sm:w-auto group px-5 sm:px-10 py-3.5 sm:py-5 rounded-full bg-gradient-to-r from-[#76ABF8] via-[#058BF4] to-[#63B3F6] text-white font-extrabold text-base sm:text-lg md:text-xl shadow-[0_20px_40px_-10px_rgba(5,139,244,0.4)] flex items-center justify-center gap-2 sm:gap-3 transition-all duration-300 hover:scale-105 active:scale-95">
              {isAr
                ? "انضم إلى صالة زيد الرياضية اليوم"
                : "Join The Zayd Gym Today"}
              <ChevronRight
                className={`w-4 h-4 sm:w-6 sm:h-6 transition-transform duration-300 ${isAr ? "rotate-180 group-hover:-translate-x-1" : "group-hover:translate-x-1"}`}
              />
            </button>
          </motion.div>
          ...
          >
            {isAr
              ? "لا حاجة لبطاقة ائتمان • ابدأ التدريب في 60 ثانية"
