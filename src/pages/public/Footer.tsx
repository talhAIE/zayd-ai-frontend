    ...
    <footer className="bg-[#0A0A0E] text-white py-14">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-24 gap-8 lg:gap-0">
          <div>
            <div className="flex flex-col sm:flex-row sm:justify-start sm:items-center gap-2 sm:gap-4 mb-4">
            ...
            <Link to="/login">
              <div className="bg-[#2a2a2a] px-6 sm:px-10 py-3 sm:py-4 rounded-full inline-block w-fit hover:bg-[#3a3a3a] transition-colors duration-300 cursor-pointer">
          ...
          <div className="relative flex items-center justify-center order-first lg:order-last">
            ...
            <span
              className="sm:flex hidden pointer-events-none absolute -top-8 -right-20"
              aria-hidden="true"
              style={{
                width: 180,
                height: 180,
            ...
            <img
              ...
              width={150}
              height={150}
              className="relative z-10 hidden sm:block sm:w-[200px] sm:h-[200px]"
            />
          </div>
        </div>
        ...
        <div className="border-t border-gray-900 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-6 justify-center sm:justify-end">
              <h3 className="text-sm sm:text-md font-light px-2 sm:px-3">
                LinkedIn
              </h3>
              <h3 className="text-sm sm:text-md font-light px-2 sm:px-3">
                Telegram
              ...
              <h3 className="text-sm sm:text-md font-light px-2 sm:px-3">X</h3>
              <h3 className="text-sm sm:text-md font-light px-2 sm:px-3">
                Instagram
              </h3>
              <h3 className="text-sm sm:text-md font-light px-2 sm:px-3">
        ...
        <div className="text-center py-6 sm:py-8">
          {/* Legal Links */}
          <div className="flex flex-wrap justify-center items-center gap-1 mb-4 text-xs sm:text-sm">
