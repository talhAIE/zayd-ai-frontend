              ...
              return (
                ...
                >
                  ...
                  <div className={isCenter ? "mt-0.5 sm:mt-1" : ""}>
                    <h3
                      className={`${isCenter ? "text-xl sm:text-3xl" : "text-lg sm:text-2xl"} font-extrabold text-gray-900 mb-1 sm:mb-2 leading-tight`}
                    >
                      {isAr ? feature.arabicTitle : feature.title}
                    </h3>
                    <p
                      className={`text-gray-500 font-medium leading-relaxed max-w-sm ${isCenter ? "text-base sm:text-lg" : "text-sm sm:text-base"}`}
                    >
