...
export default function PricingTable() {
  ...
  return (
    ...
    >
      {/* Table */}
      <motion.div
        className="w-full max-w-5xl relative z-10 rounded-xl border border-[#058BF4] bg-white overflow-hidden"
        variants={fadeInScale}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
      >
        {/* Persistent right border overlay to prevent clipping during scroll */}
        <div className="absolute inset-y-0 right-0 w-[1px] bg-[#058BF4] pointer-events-none z-20" />
        <div className="overflow-x-auto">
          <table className="min-w-full text-center bg-white shadow-sm">
            {/* Header */}
            <thead>
