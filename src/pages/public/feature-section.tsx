  ...
  const features = [
    {
      ...
      svg: (
        ...
        >
          <circle cx="19" cy="19" r="18.5" stroke="url(#paint0_linear_1_141)" />
          <path
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
              ...
              <div key={index} className="text-center">
                ...
                <p
                  className={`text-sm font-medium ${
                    feature.isActive ? "text-blue-500" : "text-gray-600"
                  }`}
                >
                  {feature.title}
                </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Side - AI Chatbot Description */}
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              <span className="text-blue-500 font-medium">AI Chatbot</span>
            ...
            <p className="w-80 text-lg text-gray-600 leading-relaxed">
              Practice speaking with an AI tutor, anytime, anywhere.
            </p>
          </div>
